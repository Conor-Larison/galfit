...
ascii.write(output,writedir+'fit_results_'+band+'.txt', delimiter = '\t', names=['Object','Centroid_X','X_Err','Centroid_Y','Y_Err', 'R_e','R_Err', 'Magnitude','Mag_Err', 'Sersic','b/a','ba_Err' ,'Chi^2'],overwrite = True)
