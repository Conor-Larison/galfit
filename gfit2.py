# Same as gfit but for a second pass. Can be copied for a third pass as well
#
...
ascii.write(output,writedir+'fit_results_2'+band+'.txt', delimiter = '\t', names=['Object','Centroid_X','X_Err','Centroid_Y','Y_Err', 'Magnitude','Mag_Err', 'R_e','R_Err', 'Sersic','b/a','ba_Err' ,'Chi^2'],overwrite = True)
